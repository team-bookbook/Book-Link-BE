package com.bookbook.booklink.chat.single.model.dto.response;

import com.bookbook.booklink.chat.chat_mutual.code.ChatStatus;
...
public class SingleRoomResDto {
    ...
    public static SingleRoomResDto fromEntity(OneToOneChats chat) {
